...
export function createHandler({origin,clientId,clientSecret,allowedEmail,store,fetchImpl=fetch}){
 ...
 const files=new Set(['index.html','config.js','app.js','backend-auth.js','sync.js','ui.js','content.js','merge.js','outline.js','journal.js','reminder-test.js','sw.js','manifest.webmanifest','favicon.ico','favicon-16.png','favicon-32.png','icon-192.png','icon-512.png','apple-touch-icon.png']);
