const CACHE_NAME="drive-memo-v3-shell-12";
const APP_SHELL=["./","./index.html","./content.js?v=20260905-10","./sync.js?v=20260905-7","./ui.js?v=20260905-10","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
