const CACHE_NAME="drive-memo-v2-shell-5";
const APP_SHELL=["./","./index.html","./content.js?v=20260905-3","./sync.js?v=20260905-3","./ui.js?v=20260905-3","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
