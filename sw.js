const CACHE_NAME="drive-memo-v2-shell-3";
const APP_SHELL=["./","./index.html","./app.js?v=20260905-1","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
