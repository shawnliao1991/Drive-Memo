const CACHE_NAME="drive-memo-v3-shell-20";
const APP_SHELL=["./","./index.html","./content.js?v=20260906-7","./sync.js?v=20260906-7","./outline.js?v=20260906-7","./journal.js?v=20260906-8","./ui.js?v=20260906-8","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
