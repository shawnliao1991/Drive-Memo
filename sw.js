const CACHE_NAME="drive-memo-v3-shell-32";
const APP_SHELL=["./","./index.html","./content.js?v=20260908-1","./sync.js?v=20260909-1","./outline.js?v=20260908-2","./journal.js?v=20260906-11","./ui.js?v=20260908-2","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
