const CACHE_NAME="drive-memo-v3-shell-17";
const APP_SHELL=["./","./index.html","./content.js?v=20260906-5","./sync.js?v=20260906-5","./outline.js?v=20260906-5","./ui.js?v=20260906-5","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
