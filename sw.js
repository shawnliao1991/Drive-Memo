const CACHE_NAME="drive-memo-v3-shell-13";
const APP_SHELL=["./","./index.html","./content.js?v=20260906-1","./sync.js?v=20260905-7","./outline.js?v=20260906-1","./ui.js?v=20260906-1","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
