const CACHE_NAME="drive-memo-v3-shell-19";
const APP_SHELL=["./","./index.html","./content.js?v=20260906-7","./sync.js?v=20260906-7","./outline.js?v=20260906-7","./journal.js?v=20260906-7","./ui.js?v=20260906-7","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
