const CACHE_NAME="drive-memo-v2-shell-7";
const APP_SHELL=["./","./index.html","./content.js?v=20260905-5","./sync.js?v=20260905-5","./ui.js?v=20260905-5","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
