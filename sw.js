const CACHE_NAME="drive-memo-v3-shell-8";
const APP_SHELL=["./","./index.html","./content.js?v=20260905-6","./sync.js?v=20260905-5","./ui.js?v=20260905-6","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
