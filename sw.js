const CACHE_NAME="drive-memo-v3-shell-18";
const APP_SHELL=["./","./index.html","./content.js?v=20260906-6","./sync.js?v=20260906-6","./outline.js?v=20260906-6","./journal.js?v=20260906-6","./ui.js?v=20260906-6","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
