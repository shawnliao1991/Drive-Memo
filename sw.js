const CACHE_NAME="drive-memo-v2-shell-4";
const APP_SHELL=["./","./index.html","./content.js?v=20260905-2","./sync.js?v=20260905-2","./ui.js?v=20260905-2","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
