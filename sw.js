const CACHE_NAME="drive-memo-v3-shell-28";
const APP_SHELL=["./","./index.html","./content.js?v=20260907-5","./sync.js?v=20260907-4","./outline.js?v=20260906-7","./journal.js?v=20260906-11","./ui.js?v=20260907-5","./config.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
